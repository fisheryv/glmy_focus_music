...
from generation.tac_v52d import _read_csv, analyze_actions
...
def main(argv: list[str] | None = None) -> int:
    ...
    outcomes_path = args.output.with_name("v52d_action_outcomes.csv")
    ...
    if args.output.is_file():
        ...
        if expected is not None and expected != sha256_file(args.action_points):
            raise LTSNContractError("V5.2d action points changed after collection")
