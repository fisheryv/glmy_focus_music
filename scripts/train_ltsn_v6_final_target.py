...
from generation.ltsn_v6_final_target import train_v6_final_target


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Train the V6 final-target diagnostic screen.")
