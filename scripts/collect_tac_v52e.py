...
from generation.tac_v52e import collect_v52e
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--v52d-repeatability-plan", type=Path, required=True)
    parser.add_argument("--v52d-repeatability-report", type=Path, required=True)
    parser.add_argument("--v52d-action-report", type=Path, required=True)
    ...
    payload = collect_v52e(
        root=args.root,
        source_manifest_path=args.source_manifest,
        v52c_plan_path=args.v52c_plan,
        v52d_repeatability_plan_path=args.v52d_repeatability_plan,
        v52d_repeatability_report_path=args.v52d_repeatability_report,
        v52d_action_report_path=args.v52d_action_report,
